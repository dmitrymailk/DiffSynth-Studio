...
class Flux2ImageTrainingModule(DiffusionTrainingModule):
    ...
    def get_pipeline_inputs(self, data):
        ...
        print("get_pipeline_inputs", data["image"].shape, data["edit_image"].shape)
        inputs_shared = {
...
class DiffusionTrainingArguments:
    ...
    source_image_name: str = field(default="input_image")
    target_image_name: str = field(default="edited_image")
