...
# Edit
accelerate launch examples/flux2/model_training/train_hf.py \
  --dataset_base_path data/example_image_dataset \
  ...
  --fp8_models "black-forest-labs/FLUX.2-klein-9B:text_encoder/*.safetensors,black-forest-labs/FLUX.2-klein-9B:transformer/*.safetensors" \
  --save_steps 300 \
